...
export const metadata: Metadata = {
  ...
  description:
    'See how FullCountProps compares to BallparkPal, EV Analytics, Action Network, FanGraphs, and Dimers. Glass-box Monte Carlo simulation at $7.99/mo vs $10–85/mo competitors.',
  keywords: [
...
const differentiators = [
  ...
  },
  {
    ...
    description:
      'Competitors charge $10 to $85 per month for less transparency and often fewer features. FullCountProps Pro starts at $7.99/mo — the most affordable option with full Monte Carlo distributions, Kelly sizing, SHAP explanations, and confidence grades included.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
